...
dataset_X = train_data[['Sex','Age','Pclass','Embarked','Fare','Cabin']]
...
with tf.Session() as sess:
    ...
    X_test = test_data[['Sex', 'Age', 'Pclass', 'Embarked', 'Fare','Cabin']]
    ...
    submission.to_csv("./Result/2-layer-nn4.csv", index=False)