...
dataset_X = train_data[['Sex','Age','Pclass','Family','Fare','Embarked']]
...
with tf.Session() as sess:
    ...
    X_test = test_data[['Sex', 'Age', 'Pclass', 'Family', 'Fare','Embarked']]
    ...
    submission.to_csv("./Result/2-layer-nn2.csv", index=False)